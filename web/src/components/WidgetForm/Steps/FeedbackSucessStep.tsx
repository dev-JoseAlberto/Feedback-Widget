...
export function FeedbackSucessStep ({
    ...
    return (
        ...
        <div className="flex flex-col items-center py-10 w-[304px]">
            ...
            className="py-2 px-6 mt-6 bg-[#0d0c22] rounded-md border-transparent text-sm leading-6 hover:bg-blue-700 transition-colors focus:outline-none focus:ring-1 focus:ring-offset-1 focus:ring-offset-[#091F8E] focus:ring-[#091F8E]"
            >
                I would like to send other feedback
            </button>
        </div>
        </>
    )
